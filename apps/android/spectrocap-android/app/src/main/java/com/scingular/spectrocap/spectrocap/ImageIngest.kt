...
/**
 * Image ingest and validation for Phase 2B media transfer.
 *
 * Acquires image from content URI (share intent, file picker, clipboard)
 * and validates format (PNG, JPEG only in Phase 2B.1).
 */
object ImageIngest {
