export const PLUMBING_DOMAIN_V1 = {
  domainKey: 'plumbing',
  version: '1.0.0',
  ...
  reportRequirements: {
    ...
    disclaimerText:
      'Plumbing findings are based on visible indicators and reported conditions at inspection time; concealed piping conditions may require further invasive verification.',
  },
} as const;
