export const MOISTURE_MOLD_DOMAIN_V1 = {
  ...
  reportRequirements: {
    ...
    disclaimerText:
      'Moisture and mold findings are based on visible indicators and available measurements; laboratory confirmation may be required.',
  },
} as const;
