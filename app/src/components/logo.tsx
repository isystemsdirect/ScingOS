    ...
    return (
      ...
      >
        <div className="relative logo-gradient-light rounded-full p-2">
            <Image src="/logo.png" alt="Scingular Logo" width={160} height={160} className="transition-all size-32 sm:size-40 md:size-48 logo-image-pulse" />
        </div>
        <div className="relative flex items-baseline justify-center">
            <ScingularLogoText className="text-2xl sm:text-3xl md:text-4xl" />
