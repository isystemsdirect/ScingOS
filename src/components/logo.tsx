      ...
      >
        ...
        <div className="relative flex items-baseline justify-center">
           <span className="font-sans uppercase font-bold italic text-2xl sm:text-3xl md:text-4xl whitespace-nowrap">
            <span className="text-scingular-glow">SCINGULAR</span> <span className="text-primary text-ai-glow text-3xl sm:text-4xl md:text-5xl">AI</span>
          </span>
          <span className="font-sans font-bold text-[0.4em] absolute top-[0.6em] right-[-4.2em] sm:top-[0.8em] sm:-right-[4.2em] md:top-[0.6em] md:-right-[3.2em]">TM</span>
        </div>
      </Link>
    );
  }
