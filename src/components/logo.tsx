    ...
    return (
      ...
      >
        ...
        <div className="relative flex items-baseline justify-center">
          <span className="font-sans uppercase font-bold italic text-3xl whitespace-nowrap">
            SCINGULAR <span className="text-primary">AI</span>
          </span>
          <span className="font-sans font-bold text-[0.4em] absolute top-[0.1em] -right-[1.4em]">TM</span>
        </div>
      </Link>
    );
  }
