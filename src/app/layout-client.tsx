...
export default function AppLayout({
  ...
  useEffect(() => {
    ...
    const connectChatUser = async () => {
      if (chatClient && mockUserId) {
        try {
           // In a real app, you would fetch a token from your backend
           // For this MVP, we will use a development token.
           // IMPORTANT: This is insecure and should only be used for development.
          await chatClient.connectUser(
            ...
            // This is a server-side generated token for development.
            // In production, this should be generated by a secure backend.
            chatClient.devToken(mockUserId)
          );
          setIsChatConnected(true);
          console.log("Stream Chat user connected.");
        } catch (error) {
