  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 lg:px-6">
      <div className="space-y-4">
        <div>
          <h1 className="text-3xl font-bold">Inspections Dashboard</h1>
          <p className="text-muted-foreground max-w-2xl mt-2">
            This is your central command for all inspection-related activities. Here you can start new inspections, track the status of ongoing work, and access finalized reports. Use the tabs to filter inspections by their current status.
          </p>
        </div>
