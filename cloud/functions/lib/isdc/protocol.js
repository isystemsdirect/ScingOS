...
exports.handleISDCMessage = functions.https.onCall(async (data, context) => {
    ...
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to use ISDCProtocol2025');
    }
    ...
    try {
        ...
        throw new functions.https.HttpsError('internal', error.message || 'ISDCProtocol2025 operation failed');
    }
});
/**
