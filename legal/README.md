...
1. **[PARTNER_LICENSE_AGREEMENT.md](./PARTNER_LICENSE_AGREEMENT.md)**
   - Private partner license terms
   - Rights and restrictions for integration partners
   - Confidentiality and termination provisions

2. **[CONTRIBUTOR_LICENSE_AGREEMENT.md](./CONTRIBUTOR_LICENSE_AGREEMENT.md)**
   - CLA for code contributors
   - IP assignment and certification requirements
...
4. **[ENTERPRISE_SERVICE_AGREEMENT.md](./ENTERPRISE_SERVICE_AGREEMENT.md)**
   - B2B service agreement for enterprise customers
   - Service levels, fees, and support terms
   - Data ownership and security provisions

### Terms and Policies

5. **[TERMS_OF_USE.md](./TERMS_OF_USE.md)**
...
7. **[DATA_PROCESSING_ADDENDUM.md](./DATA_PROCESSING_ADDENDUM.md)**
   - DPA for enterprise customers
   - GDPR compliance provisions
   - Sub-processor management and data transfers

### Intellectual Property

8. **[TRADEMARK_GUIDELINES.md](./TRADEMARK_GUIDELINES.md)**
   - Proper usage of SCINGOS and SCINGULAR trademarks
   - Permitted and prohibited uses
   - Brand protection and enforcement

9. **[PRELIMINARY_PATENT_DRAFT.md](./PRELIMINARY_PATENT_DRAFT.md)**
   - Patent preparation documentation (CONFIDENTIAL)
   - Novel technical features and claims
   - Prior art analysis and protection strategy

### Security and Compliance

10. **[SECURITY_POLICY.md](./SECURITY_POLICY.md)**
    - Comprehensive security framework
    - BANE architecture and controls
...
Additional legal and governance documentation can be found in:

- **[/COPYRIGHT](../COPYRIGHT)** - Copyright notice
- **[/LICENSE](../LICENSE)** - Software license
- **[/LEGAL.md](../LEGAL.md)** - Legal overview and ownership
- **[/TRADEMARK.md](../TRADEMARK.md)** - Trademark notice
- **[/NOTICE](../NOTICE)** - Legal notices
- **[/PATENT_PREP.md](../PATENT_PREP.md)** - Patent preparation notes
- **[/docs/LEGAL-FRAMEWORK.md](../docs/LEGAL-FRAMEWORK.md)** - Comprehensive legal framework
...
- **Privacy**: privacy@isystemsdirect.com
- **Security**: security@isystemsdirect.com
- **Partnerships**: partnerships@isystemsdirect.com
- **DPO (GDPR)**: dpo@isystemsdirect.com

---

## Document Updates

All legal documents are version-controlled. For the latest versions and change history, refer to the repository commit history.
