...
These guidelines govern the use of Inspection Systems Direct LLC's trademarks, service marks, trade names, and logos (collectively, "Marks"). All Marks are the exclusive property of Inspection Systems Direct LLC ("ISD").

---

## 2. Protected Marks

The following are registered or common law trademarks of ISD:

- **SCINGOS™**
- **SCINGULAR™**
- **SCINGULAR AI/OS™**
- **SCING™** (the voice interface persona)
...
- **Powered by Scing™**
- ISD logos and design marks

All associated logos, product names, and branding are also protected.
...
- Use does not imply endorsement, sponsorship, or affiliation without authorization
- Use does not disparage ISD or its products
...
- Register or attempt to register any Mark confusingly similar to ours
- Use our Marks in a manner that implies partnership, sponsorship, or endorsement without written authorization
- Alter, modify, or create composite marks incorporating our Marks
- Use our Marks in a misleading or disparaging manner
...
- Do not distort, rotate, or alter logos
- Maintain proper color specifications (RGB/CMYK values provided)
...
- Subject to quality control and compliance audits
- Logo files and usage specifications provided upon approval
...
ISD may update these guidelines periodically. Current version available at:
...
These guidelines do not grant any license or permission to use ISD's trademarks. All trademark rights are expressly reserved by Inspection Systems Direct LLC.

Compliance with these guidelines does not waive any trademark rights or create any implied license. ISD may enforce its rights regardless of compliance with these guidelines.
